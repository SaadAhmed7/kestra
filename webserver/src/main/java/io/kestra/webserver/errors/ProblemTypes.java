 ...
 * that must also gain a documentation page.
 */
public final class ProblemTypes {
    ...
    public static final ProblemType INVALID_JSON_MAPPING = ProblemType.of("invalid-json-mapping", "Invalid JSON mapping", 422);
    ...
    public static final ProblemType RESOURCE_VALIDATION_FAILED = ProblemType.of("resource-validation-failed", "Resource fails validation", 400);
