...
class ExecutionDependenciesStreamingServiceDispatchTest {
    ...
    void init() {
        ...
        when(executionRepository.findById(TENANT_ID, EXECUTION_ID)).thenReturn(Optional.of(execution));
    ...
    void shouldNotFailWhenExecutionIsNotFound() {
        ...
        when(executionRepository.findById(TENANT_ID, EXECUTION_ID)).thenReturn(Optional.empty());
