...
class ExecutionStreamingServiceDispatchTest {
    ...
    void init() {
        ...
        when(executionRepository.findById(null, EXECUTION_ID)).thenReturn(Optional.of(execution));
    ...
    void shouldNotFailWhenExecutionIsNotFound() {
        ...
        when(executionRepository.findById(null, EXECUTION_ID)).thenReturn(Optional.empty());
